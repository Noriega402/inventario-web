        ...
        <div class="flex items-center justify-between">
            <div class="flex items-center justify-start rtl:justify-end">
                ...
                <a href="/" class="ms-2 flex md:me-24">
                    <img src="{{ asset('imgs/logo-tecnoprosa.png') }}" class="me-3 h-8" alt="Logo Tecnoprosa" />
                    <span
                        class="self-center whitespace-nowrap text-xl font-semibold sm:text-2xl dark:text-white"></span>
                </a>
            </div>
